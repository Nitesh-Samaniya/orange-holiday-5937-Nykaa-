...
import natural from "../Images/Pages/natural.avif"
...
function Natural() {
  ...
  useEffect(()=>{
    setLoading(true);
    let apiUrl = getUrl(
      `https://nykaa-server.onrender.com/natural?_page=${page}&_limit=9`,
      sort,
      orderBy,
      filterBy
    );
  ...
  return (
    <Box w="78%" m='auto' mt='5' mb='5'>
      ...
      <Box color='gray.500'>
        <Breadcrumb spacing='8px' separator={<ChevronRightIcon color='gray.500' />}>
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href='/makeup'>Natural</BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <Box textAlign='center'>
        ...
        <Image src={natural} alt="natural" mb={3} mt={3}/>
      </Box>
