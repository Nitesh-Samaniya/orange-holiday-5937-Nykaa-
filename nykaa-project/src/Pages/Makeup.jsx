...
import makeupBanner from "../Images/Pages/makeupbanner.avif"
...
function Makeup() {
  ...
  useEffect(()=>{
    setLoading(true);
    let apiUrl = getUrl(
      `https://sale-asos-women.herokuapp.com/makeup?_page=${page}&_limit=9`,
      sort,
      orderBy,
      filterBy
    );
  ...
  return (
    <Box w="78%" m='auto' mt='5' mb='5'>
      ...
      <Box textAlign='center'>
        ...
        <Image src={makeupBanner} alt="makeupBanner" mb={3} mt={3}/>
      </Box>
