...
import healthAndWellness from "../Images/Pages/healthAndWellness.avif"
...
function HealthAndWellness() {
  ...
  useEffect(()=>{
    setLoading(true);
    let apiUrl = getUrl(
      `https://nykaa-server.onrender.com/health?_page=${page}&_limit=9`,
      sort,
      orderBy,
      filterBy
    );
  ...
  return (
    <Box w="78%" m='auto' mt='5' mb='5'>
      ...
      <Box color='gray.500'>
        <Breadcrumb spacing='8px' separator={<ChevronRightIcon color='gray.500' />}>
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href='/makeup'>Health And Wellness</BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <Box textAlign='center'>
        ...
        <Image src={healthAndWellness} alt="healthAndWellness" mb={3} mt={3}/>
      </Box>
