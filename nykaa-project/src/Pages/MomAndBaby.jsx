...
import momAndBaby from "../Images/Pages/momAndBaby.avif"
...
function MomAndBaby() {
  ...
  useEffect(()=>{
    setLoading(true);
    let apiUrl = getUrl(
      `https://nykaa-server.onrender.com/mom?_page=${page}&_limit=9`,
      sort,
      orderBy,
      filterBy
    );
  ...
  return (
    <Box w="78%" m='auto' mt='5' mb='5'>
      ...
      <Box color='gray.500'>
        <Breadcrumb spacing='8px' separator={<ChevronRightIcon color='gray.500' />}>
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href='/makeup'>Mom And Baby</BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <Box textAlign='center'>
        ...
        <Image src={momAndBaby} alt="momAndBaby" mb={3} mt={3}/>
      </Box>
