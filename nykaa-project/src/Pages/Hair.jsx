...
import hair from "../Images/Pages/hair.avif"
...
function Hair() {
  ...
  useEffect(()=>{
    setLoading(true);
    let apiUrl = getUrl(
      `https://nykaa-server.onrender.com/hair?_page=${page}&_limit=9`,
      sort,
      orderBy,
      filterBy
    );
  ...
  return (
    <Box w="78%" m='auto' mt='5' mb='5'>
      ...
      <Box color='gray.500'>
        <Breadcrumb spacing='8px' separator={<ChevronRightIcon color='gray.500' />}>
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href='/makeup'>Hair</BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <Box textAlign='center'>
        ...
        <Image src={hair} alt="hair" mb={3} mt={3}/>
      </Box>
