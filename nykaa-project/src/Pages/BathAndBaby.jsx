...
import bathAndBaby from "../Images/Pages/bathAndBaby.avif"
...
function BathAndBaby() {
  ...
  useEffect(()=>{
    setLoading(true);
    let apiUrl = getUrl(
      `https://sale-asos-women.herokuapp.com/bath?_page=${page}&_limit=9`,
      sort,
      orderBy,
      filterBy
    );
  ...
  return (
    <Box w="78%" m='auto' mt='5' mb='5'>
      ...
      <Box color='gray.500'>
        <Breadcrumb spacing='8px' separator={<ChevronRightIcon color='gray.500' />}>
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href='/makeup'>Bath and Baby</BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <Box textAlign='center'>
        ...
        <Image src={bathAndBaby} alt="makeupBanner" mb={3} mt={3}/>
      </Box>
